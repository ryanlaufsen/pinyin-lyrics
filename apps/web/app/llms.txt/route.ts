...
export function GET() {
  const lines = [
    ...
    `- [八方来财 practice shell](${absoluteSiteUrl("/static/bafang-laicai/")}) Static practice shell for user-provided lyrics.`,
