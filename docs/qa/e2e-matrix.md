...
| --- | --- | --- | --- |
| Chinese pinyin | Not Yet Committed | Romanization/NLP Manager | Needs legally clean fixture and adapter tests. |
...
| --- | --- | --- | --- |
| Keyboard navigation and focus visibility | Blocked Exception | QA/Accessibility Manager | Add to route contract coverage in QA-002. |
| Control names, roles, and states | Blocked Exception | QA/Accessibility Manager | Add role/name assertions in QA-002. |
